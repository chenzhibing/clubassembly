...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="<%=ctx %>/manager/organization/organizationmembermanager?id=${organization.id}" class="current">
                社团成员信息
            </a>
        </div>
    </div>
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"> <i class="icon-th"></i> </span>
                        ...
                        <a class="label label-important" href="#">分配部门</a>
                        <a class="label label-important" href="#">分配职位</a>
                    </div>
