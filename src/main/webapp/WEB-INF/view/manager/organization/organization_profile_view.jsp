...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="<%=ctx %>/manager/organization/organizationprofileview?id=${organization.id}" class="current">
                社团详情
            </a>
        </div>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="get" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" disabled="" value="${organization.slogan}"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span4" disabled=""
                                           value="${organization.organizationMainCategory.name}"/>
                                    <input type="text" class="span4" disabled=""
                                           value="${organization.organizationSecondCategory.name}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" disabled=""
                                           value="${organization.property.property}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" rows="5"
                                              disabled="">${organization.organizationIntroduce}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" rows="5"
                                              disabled="">${organization.departmentIntroduce}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" rows="5"
                                              disabled="">${organization.contactInformation}</textarea>
                                </div>
                            </div>
