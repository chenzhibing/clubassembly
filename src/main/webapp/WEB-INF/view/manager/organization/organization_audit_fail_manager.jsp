...
<html lang="en">
<head>
    <script src="<%=ctx %>/static/js/organizationmanager.js">
    </script>
</head>
<body>
<!--主容器开始-->
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="<%=ctx %>/manager/home" class="tip-bottom"><i class="icon-home"></i> 首页</a>
            ...
            <a href="<%=ctx %>/manager/organization/organizationauditfailmanager" class="current">审核未通过社团</a>
        </div>
    </div>
    <!--痕迹导航开始结束-->
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"> <i class="icon-th"></i> </span>
                        ...
                        <a class="label label-important" href="#"
                           onclick="organizationDelete('auditFailOrganizations')">删除</a>
                        <a class="label label-important" href="#"
                           onclick="organizationUpdate('auditFailOrganizations')">修改信息</a>
                        <a class="label label-important" href="#"
                           onclick="organizationView('auditFailOrganizations')">查看详情</a>
                    </div>
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            <thead>
                            <tr>
                                <th><input type="checkbox" id="auditFailOrganizationscheckbox"
                            ...
                            <tbody id="auditFailOrganizationstbody">
                            <c:if test="${auditFailOrganizations != null && auditFailOrganizations.size() > 0}">
                                <c:forEach var="organization" items="${auditFailOrganizations}" varStatus="status">
                                    <tr>
                                        <td>
                                            <center>
