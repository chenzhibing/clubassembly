...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="<%=ctx %>/manager/home" class="tip-bottom"><i class="icon-home"></i> 首页</a>
            ...
            <a href="<%=ctx %>/manager/organization/organizationalreadydeletemanager" class="current">已删除社团</a>
        </div>
    </div>
    <!--痕迹导航开始结束-->
                ...
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"> <i class="icon-th"></i> </span>
                        ...
                        <a class="label label-important" href="#"
                           onclick="organizationDelete('deleteOrganizations')">删除</a>
                        <a class="label label-important" href="#" id="organizationrestore">还原社团</a>
                        <a class="label label-important" href="#"
                           onclick="organizationView('deleteOrganizations')">查看详情</a>
                    </div>
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            <thead>
                            <tr>
                                <th><input type="checkbox" id="deleteOrganizationscheckbox"
                            ...
                            <tbody id="deleteOrganizationstbody">
                            <c:if test="${deleteOrganizations != null && deleteOrganizations.size() > 0}">
                                <c:forEach var="organization" items="${deleteOrganizations}" varStatus="status">
                                    <tr>
                                        <td>
                                            <center>
