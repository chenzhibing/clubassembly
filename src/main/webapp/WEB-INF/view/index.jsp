        ...
        <div>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <center>
                        <div style="color:#090909;margin-top: 30px">
                            <button class="btn btn-inverse" type="button" data-toggle="modal" data-backdrop="static"
                                    data-target="#myModal">创建一个社团
                            </button>
                        </div>
                    </center>
                </div>
        ...
        <div class="col-sm-5 col-md-5 col-lg-5">
            ...
            <div class="row" style="margin-top: 5px;">
                <div class="col-lg-offset-1 col-sm-12 col-md-12 col-lg-12">
                    <button class="btn btn-inverse" type="button" data-toggle="modal" data-backdrop="static"
                            data-target="#myModal" id="hotButton">我要上头条
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">暂不登陆</button>
                <button type="button" class="btn btn-primary" id="modalBackButtion">去登陆</button>
            </div>
        </div>
    </div>
</div>
