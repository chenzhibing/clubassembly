...
<div class="container-fluid" style="margin-top: 20px;">
    <div class="container">
        <form action="<c:url value="/organizationmaintain/addmessage"/>" method="post" class="form-horizontal"
              role="form">
            <input type="hidden" value="${organization.id}" name="organizationid"/>
            <input type="hidden" value="manageraccess" name="type"/>
            ...
            <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="row">
                        <center>
                            <img
                                    class="img-circle"
                                    alt="140x140"
                                    style="width: 60px; height: 60px;" src="<shiro:principal property="image"/>"
                                    data-holder-rendered="true"/>
                        </center>
                    </div>
                    <div class="row">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control" rows="3" name="content">你想对他说...</textarea>
                </div>
            </div>
            <div class="row">
                <div class="form-group">
                    <div class="col-lg-offset-6  col-sm-2">
                        <button type="submit" class="btn btn-block btn-inverse">发布
                        </button>
                    </div>
                </div>
            </div>
        ...
        <c:if test="${messageses != null && messageses.size() > 0}">
            <c:forEach items="${messageses}" var="message" varStatus="status">
                <div class="row" style="margin-top: 20px;">
                    <div class="col-lg-offset-1 col-sm-1">
                        <div class="row">
                            <center>
                                <a href="<c:url value="/student/studentprofilemain?studentid=${message.student.id}"/>">
                                    <img
                                            class="img-circle"
                                            alt="140x140"
                                            style="width: 60px; height: 60px;"
                                            src="${"/clubassembly/"}${message.student.image}"
                                            data-holder-rendered="true"/>
                                </a>
                            </center>
                        </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="row">
                            <button type="button" class="btn btn-block btn-inverse">回复
                            </button>
                        </div>
                    </div>
                </div>
