    ...
    <div class="container">
        <div class="row" style="margin-top: 20px;">
            <div class="col-sm-2 col-md-2 col-lg-2">
                <img src="<%=ctx %>/static/image/tip.png" width="10px" height="20px;"/>社团口号
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-sm-2 col-md-2 col-lg-2">
                <img src="<%=ctx %>/static/image/tip.png" width="10px" height="20px;"/>社团介绍
            </div>
        </div>
        <div class="row">
            <div class="col-lg-offset-1 col-sm-10 col-md-10 col-lg-10">
                ${organization.organizationIntroduce}
            </div>
        </div>
        <div class="row" style="margin-top: 20px;">
            <div class="col-sm-2 col-md-2 col-lg-2">
                <img src="<%=ctx %>/static/image/tip.png" width="10px" height="20px;"/>部门介绍
            </div>
        </div>
        <div class="row">
            <div class="col-lg-offset-1 col-sm-10 col-md-10 col-lg-10">
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-sm-2 col-md-2 col-lg-2">
                <img src="<%=ctx %>/static/image/tip.png" width="10px" height="20px;"/>联系方式
            </div>
        </div>
        <div class="row">
            <div class="col-lg-offset-1 col-sm-10 col-md-10 col-lg-10">
