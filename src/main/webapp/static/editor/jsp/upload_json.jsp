...
<%
    ...
    System.out.print(savePath);
    savePath = savePath.substring(0, savePath.indexOf("webapps/clubassembly/"));
    savePath = savePath + "/clubassemblyResources/organization/events/";


    //文件保存目录URL
    String saveUrl = request.getContextPath() + "/clubassemblyResources/organization/events/";
